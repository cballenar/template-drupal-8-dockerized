...
COPY drupal.apache.conf /etc/apache2/sites-enabled/000-default.conf

RUN rm -rf /var/www/html/web && composer create-project drupal/recommended-project:8.9.13 /var/www/html/
